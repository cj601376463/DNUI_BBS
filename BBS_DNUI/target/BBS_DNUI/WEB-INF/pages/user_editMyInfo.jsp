...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        <form class="form-inline" method="post" action="${path}/user/myInfoUpdate" enctype="multipart/form-data">
            <input type="hidden" value="<%=user.getUser_id()%>" name="user_id">
            <span class="text-info">用户名：</span>
            <label><input class="form-control" value="<%=user.getUsername()%>" name="username"></label><br/><br/>
            ...
            <label><input class="form-control"  name="sdept" value="<%=user.getSdept()%>"></label><br/><br/>

            <span class="text-info">班&nbsp;&nbsp; 级：</span>
            <label><input class="form-control" name="clazz" value="<%=user.getClazz()%>"></label><br/><br/>

            <span class="text-info">手&nbsp;&nbsp; 机：</span>
            <label><input class="form-control" name="phone" value="<%=user.getPhone()%>" pattern="^1[0-9]{10}$"></label><br/><br/>
            ...
            <img class="img-circle" id="ImgPr" src="${path }/pic/heads/<%=headImage%>" width="110px"
                 height="110px" alt=""><br/><br/>

            <span class="text-info">签&nbsp;&nbsp;名：</span>
            <label><input class="form-control" value="<%=user.getSign()%>" name="sign"></label><br/><br/>
